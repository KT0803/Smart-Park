    ...
    <div className="min-h-screen bg-gray-950 flex flex-col overflow-x-hidden">
      ...
      <nav className="fixed top-0 w-full z-50 bg-gray-950/80 backdrop-blur-md border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-white text-lg tracking-tight">Smart Park</span>
          </div>
          <div className="flex items-center gap-3">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen text-center px-6 pt-16">
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-blue-600/10 border border-blue-600/30 rounded-full px-4 py-1.5 text-sm text-blue-400 mb-8">
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-3">Available Cities</h2>
          <p className="text-gray-400 text-center mb-12">Parking lots across major Indian cities</p>
      ...
      <section className="py-20 px-6">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-3xl font-bold text-white text-center mb-12">Why Smart Park?</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <div className="card border-blue-600/30">
            <h2 className="text-3xl font-bold text-white mb-4">Ready to park smarter?</h2>
            <p className="text-gray-400 mb-8">Join thousands of drivers who use Smart Park daily.</p>
      ...
      <footer className="border-t border-white/5 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-400">Smart Park © 2026</span>
          </div>
